...
def myNetwork():
    ...
    r5 = net.addHost('r5', cls=Node, ip='192.168.1.6/30')
    ...
    h1 = net.addHost('h1', cls=Host, ip='10.0.1.50/24', defaultRoute='via 10.0.1.5')
    ...
    h3 = net.addHost('h3', cls=Host, ip='10.0.2.50/24', defaultRoute='via 10.0.2.5')
